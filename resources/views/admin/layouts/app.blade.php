...
<head>
    ...
    <title>{{ ucfirst(app_setting('app_name', 'App')) }} - {{ ucfirst($title ?? '') }}</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset(app_setting('favicon', 'assets/img/favicon.png')) }}">
    <!-- Bootstrap CSS -->
